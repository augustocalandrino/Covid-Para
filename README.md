# Covid-Pará
## Dashboard para Monitoramento do Covid-19 no Estado do Pará

Casos e óbitos confirmados por dia, utilizando informação oficial do Ministério da Saúde, dados no nível municipal do Brasil.IO e dados mais recentes reportados pela equipe do @CoronavirusBra1.

Os dados sobre o número de recuperados por estado foram obtidos a partir da planilha atualizada pelo @CoronavirusBra1 usando os boletins de cada estado.
...
# (en) Covid-Pará 
## Dashboard for Monitoring Covid-19 in the State of Pará
...
The data for the number of recovered individuals were obtained from the [spreadsheet](https://docs.google.com/spreadsheets/d/1MWQE3s4ef6dxJosyqvsFaV4fDyElxnBUB6gMGvs3rEc/edit?usp=sharing) updated by [@CoronavirusBra1](https://twitter.com/CoronavirusBra1) using the reports for each state.
